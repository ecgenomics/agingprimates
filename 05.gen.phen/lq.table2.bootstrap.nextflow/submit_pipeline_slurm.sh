...
#SBATCH --job-name=genphen-bootstrap-driver
#SBATCH --cpus-per-task=1
#SBATCH --mem=16G
#SBATCH --time=7-00:00:00
#SBATCH --partition=std-cpu
#SBATCH --output=logs/genphen-bootstrap-driver-%j.out
#SBATCH --error=logs/genphen-bootstrap-driver-%j.err
...
# shared by the Nextflow driver and all submitted bootstrap tasks.
...
echo "GenPhen CAAStools bootstrap driver"
